Pod::Spec.new do |spec|
    ...
    spec.homepage                 = 'https://github.com/AmberId/amber-messenger'
    spec.source                   = { :http=> ''}
    spec.authors                  = ''
    spec.license                  = ''
    spec.summary                  = 'Firebase integration module'
    ...
    if !Dir.exist?('build/cocoapods/framework/firebase.framework') || Dir.empty?('build/cocoapods/framework/firebase.framework')
        ...
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:
            ./gradlew :modules:core:firebase:generateDummyFramework
    ...
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':modules:core:firebase',
