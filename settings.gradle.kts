...
include(":modules:core:auth")
include(":modules:core:preferences")
include(":modules:core:client:api")
include(":modules:core:client:impl")
include(":modules:core:image-loading")
include(":modules:core:media-player")
include(":modules:core:analytics")
include(":modules:core:firebase")
include(":modules:core:logger")
include(":modules:core:network-monitor")
include(":modules:core:power-monitor")
